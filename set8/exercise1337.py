...
def password_please() -> str:
    ...
    the_answer = str("Avacados")
    return the_answer


def list_please() -> list:
    """Returns a list, you can put anything in the list."""
    the_answer = list("cat, dog, chicken")
    return the_answer
...
def dictionary_please() -> dict:
    ...
    a_dictionary = {"name": "Sandy", "pet": "cat", "hair": "black"}
    return a_dictionary
...
def best_letter_for_pets() -> str:
    ...
    for letter in the_alphabet:
        ...
        if len(filtered_pets) > max_pets_count:
            max_pets_count = len(filtered_pets)
